...
// --- 1. Only allowing POST requests (not direct URL access) ---
...
// --- 2. Getting the project ID from the form ---
if (!isset($_POST['id']) || !is_numeric($_POST['id'])) {
    header("Location: projects.php");
    exit();
}

$id = (int)$_POST['id']; // Converted to integer for safety

// --- 3. Get the redirect target ---
// i.e redirect field tells us where to go after deleting
//so go to default projects.php if not specified
...
// --- 5. Redirect with a status message ---
...
// exit() ensures no more code runs after redirecting
exit();
?>
